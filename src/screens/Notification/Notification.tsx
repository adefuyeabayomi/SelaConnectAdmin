...
export default function Notification ({navigation}: ScreenProps): React.JSX.Element{
    ...
    return (
        <SafeAreaView style={styles.safeAreaView}>
            ...
            <AbsNav location="info" goToHome={goToHome} goToNotifications={goToNotifications} goToSupport={goToSupport} goToRecords={goToBookingRecords} goToPending={goToPending}></AbsNav>
            ...
            <ScrollView>
                ...
                <View>
                    ...
                    <View style={paddings.p10}>
                        <NotificationItem type={'bookingSuccess'} text={'Booking Successful. Booking saved as “Delivery of electronics to Aleliaide Kemi. ID : XXI32874HF8HF8943H34T'}/>
                    </View>
                    <View style={paddings.p10}>
                        <NotificationItem type={'bookingSuccess'} text={'Booking Successful. Booking saved as “Delivery of electronics to Aleliaide Kemi. ID : XXI32874HF8HF8943H34T'}/>
                    </View>
