...
export default function ChatList ({navigation}: ScreenProps): React.JSX.Element{
        ...
        <SafeAreaView style={styles.safeAreaView}>
            ...
            <ScrollView>
                ...
                <View style={paddings.p10}>
                    <ChatMsgOverview actionFn={goToChatPage} name="Ololademi Asake" message="I want to play a game.I want to play a game.I want to play a game.I want to play a game." />
                </View>
                <View style={paddings.p10}>
                    <ChatMsgOverview actionFn={goToChatPage} name="Ololademi Asake" message="I want to play a game. I want to play a game.I want to play a game." />
                </View>
                <View style={paddings.p10}>
                    <ChatMsgOverview actionFn={goToChatPage} name="Ololademi Asake" message="I want to play a game." />
                </View>
                <View style={paddings.p10}>
                    <ChatMsgOverview actionFn={goToChatPage} name="Ololademi Asake" message="I want to play a game.I want to play a game.I want to play a game.I want to play a game." />
                </View>
