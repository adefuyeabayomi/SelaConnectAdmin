...
import { ChatMsgOverview, InvoicesDayItem, RidersBookingItem, RidersItemComponent, UpcomingDeliveries, UserMessageItem } from "../../components/Items/item";
import { BookingSummary } from "../../components/ManageBookings/ManageBookingsComponents";
export default function CSView ({navigation}: CVScreenProps): React.JSX.Element{
        ...
        <SafeAreaView style={styles.safeAreaView}>
            ...
            <ScrollView>
                ...
                <View style={[paddings.p15,margins.m10,borderStyles.bWidth1]}>
                    ...
                    <View   style={[borderStyles.r15,{borderColor: efficiency.efficiencyShade4}]}>
                        <RidersBookingItem tag1={'Express'} tag2={'Pay On Delivery'}></RidersBookingItem>
                    </View>
                </View>
                <View style={[paddings.p15,margins.m10,borderStyles.bWidth1]}>
                    <SmallRegular>Upcoming Deliveries Component</SmallRegular>
                    <View  style={[borderStyles.r15,{borderColor: efficiency.efficiencyShade4}]}>
                        <UpcomingDeliveries date={'April 12 2024'} amount={8}></UpcomingDeliveries>
                    </View>
                </View>
                <View style={[paddings.p15,margins.m10,borderStyles.bWidth1]}>
                    <SmallRegular>Rider Item Component</SmallRegular>
                    <View  style={[borderStyles.r15,{borderColor: efficiency.efficiencyShade4}]}>
                        <RidersItemComponent name={'Adeleye Emmanuel'} employmentHistory={'Employed from september 14th, 2024 till present'}></RidersItemComponent>
                    </View>
                </View>
                <View style={[paddings.p15,margins.m10,borderStyles.bWidth1]}>
                ...
                <View style={[paddings.p15,margins.m10,borderStyles.bWidth1]}>
                    ...
                    <View  style={[borderStyles.r15,{borderColor: efficiency.efficiencyShade4}]}>
                        <InvoicesDayItem date={'April 12 2024'} amount={30} paid={25} unpaid={5}></InvoicesDayItem>
                    </View>
                </View>
                <View style={[paddings.p15,margins.m10,borderStyles.bWidth1]}>
                    <SmallRegular>Invoice Item Component</SmallRegular>
                    <View  style={[borderStyles.r15,{borderColor: efficiency.efficiencyShade4}]}>
                        <ChatMsgOverview name={'Ogharerunmi'} message={'I would like to complain about the blah...'}></ChatMsgOverview>
                    </View>
                </View>
                <View style={[paddings.p15,margins.m10,borderStyles.bWidth1]}>
