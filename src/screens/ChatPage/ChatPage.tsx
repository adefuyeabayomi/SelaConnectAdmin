        ...
        <SafeAreaView style={styles.safeAreaView}>           
            ...
            <ScrollView>
                ...
                <View style={[paddings.ph10,paddings.pt10]}>
                    <UserMessageItem>I want to complain about my delivery which i booked some two days ago. I didnt get it on time.</UserMessageItem>
                </View>
                <View style={[paddings.ph10,paddings.pt10]}>
                    <AdminMessageItem>Hi, Damie, Sorry for the inconvinience. the fault is ours and we sincerely apologise.</AdminMessageItem>
                </View>
                <View style={[paddings.ph10,paddings.pt10]}>
                    <AdminMessageItem>Hi, Damie, Sorry for the inconvinience. the fault is ours and we sincerely apologise.</AdminMessageItem>
                </View>
