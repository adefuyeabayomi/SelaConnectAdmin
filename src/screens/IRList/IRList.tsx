    ...
    return (
        <SafeAreaView style={styles.safeAreaView}>
            ...
            <ScrollView>
                ...
                <Text style={[paraStyles.para_bold,centerText.center,paddings.pt20]}>All invoices</Text>
                </View>

                <View style={[paddings.p10]}>
                    <InvoiceItem paid={true} bookingId="XXiewo39901j02f" details="Delivery of electronics to Mr Chuks." paymentMethod="Pay Online" date="April 25, 2024" amount="5500" />
                </View>
                <View style={[paddings.p10]}>
                    <InvoiceItem paid={false} bookingId="XXiewo39901j02f" details="Delivery of electronics to Mr Chuks." paymentMethod="Pay Online" date="April 25, 2024" amount="5500" />
                </View>
                <View style={[paddings.p10]}>
                    <InvoiceItem paid={false} bookingId="XXiewo39901j02f" details="Delivery of electronics to Mr Chuks." paymentMethod="Pay Online" date="April 25, 2024" amount="5500" />
                </View>
