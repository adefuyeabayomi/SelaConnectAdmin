...
let pendingIcon = (
  <MaterialCommunityIcons name="briefcase-clock-outline" size={18} />
);
let messageIcon = (
  <MaterialCommunityIcons name="message-minus-outline" size={18} />
);
...
function NavBar({
  ...
  goToNotifications,
  location,
}: AbsNavPropType): React.JSX.Element {
  ...
  let activeIndicator = (
    <View style={styles.idIndicator} id="activeIndicator" />
  );
  return (
    <View style={styles.navContainerMain}>
      <View style={styles.navContainer}>
        <View style={styles.navItem}>
          <TouchableOpacity
            style={[styles.homeTouchContainer, styles.navItem]}
            onPress={goToHome}
          >
            <View>
              <View>
        ...
        <View style={styles.navItem}>
          <TouchableOpacity
            style={[styles.touchContainer, styles.navItem]}
            onPress={goToPending}
          >
            <View>
              <View>
        ...
        <View style={styles.navItem}>
          <TouchableOpacity
            style={[styles.infoTouchContainer, styles.navItem]}
