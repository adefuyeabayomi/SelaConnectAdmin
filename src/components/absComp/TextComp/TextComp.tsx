...
export function SmallRegular({
  style,
  children,
}: textStyle): React.JSX.Element {
  return (
    <Text
      style={[
...
export function h4Bold({ style, children }: textStyle): React.JSX.Element {
  return (
    <Text
      style={[h4Styles.h4_bold, { color: efficiency.efficiencyShade5 }, style]}
    >
      {children}
    </Text>
  );
...
export function h4Light({ style, children }: textStyle): React.JSX.Element {
  return (
    <Text
      style={[h4Styles.h4_light, { color: efficiency.efficiencyShade5 }, style]}
    >
      {children}
    </Text>
  );
...
export function h5Bold({ style, children }: textStyle): React.JSX.Element {
  return (
    <Text
      style={[h5Styles.h5_bold, { color: efficiency.efficiencyShade5 }, style]}
    >
      {children}
    </Text>
  );
...
export function h5Light({ style, children }: textStyle): React.JSX.Element {
  return (
    <Text
      style={[h5Styles.h5_light, { color: efficiency.efficiencyShade5 }, style]}
    >
      {children}
    </Text>
  );
...
export function h6Bold({ style, children }: textStyle): React.JSX.Element {
  return (
    <Text
      style={[h6Styles.h6_bold, { color: efficiency.efficiencyShade5 }, style]}
    >
      {children}
    </Text>
  );
...
export function h6Light({ style, children }: textStyle): React.JSX.Element {
  return (
    <Text
      style={[h6Styles.h6_light, { color: efficiency.efficiencyShade5 }, style]}
    >
      {children}
    </Text>
  );
