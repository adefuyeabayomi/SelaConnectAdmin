...
let penIcon = (
  <FontAwesome5 name="pen-alt" size={24} color={efficiency.efficiencyTint1} />
);

import { nStyles } from "./style";
import { ParaBold, ParaRegular, SmallBold } from "../TextComp/TextComp";
import { Colors } from "react-native/Libraries/NewAppScreen";
import { FlexRow, Flex0, Flex1 } from "../LayoutComp/LayoutComp";
import { MBDataItem1 } from "../ManageBookings/ManageBookingsComponents";
...
export function Item1({
  ...
  body,
  actionFn,
}: Item1PropType): React.JSX.Element {
  return (
...
let bookingItemImageComponent = (
  <Image
    style={styles.BIImage}
    source={require("../../assets/images/bookingItem.png")}
  />
);
export function BookingItem({
  ...
  paid,
  actionFn,
}: BookingItemPropTypes): React.JSX.Element {
  let paidIndicator = paid ? (
    <Text style={{ color: utilityColors.infoDeep }}>Paid</Text>
  ) : (
    <Text style={{ color: utilityColors.errorDeep }}>Not Paid</Text>
  );
  return (
    <View
      style={[
        styles.BIContainer,
        layoutVals.flexRow,
        layoutVals.alignCenter,
        layoutVals.justifyCenter,
        borderStyles.bWidth2,
        paddings.p10,
        borderStyles.r15,
        { borderColor: efficiency.efficiencyTint5 },
      ]}
    >
      <View style={[layoutVals.flex0]}>
        <View style={borderStyles.r20}>{bookingItemImageComponent}</View>
      </View>
...
let trackingItemImageComponent = (
  <Image
    style={styles.TIImage}
    source={require("../../assets/images/trackingItem.png")}
  />
);
export function TrackingItem({
  ...
  tag2,
  actionFn,
}: TrackingItemPropTypes): React.JSX.Element {
  return (
    <View
      style={[
        styles.BIContainer,
    ...
    >
      <View style={[layoutVals.flex0]}>
        <View style={borderStyles.r20}>{trackingItemImageComponent}</View>
      </View>
      <View style={[layoutVals.flex1, paddings.pl10]}>
        <View>
          <Text
...
let historyItemImageComponent = (
  <Image
    style={styles.HIImage}
    source={require("../../assets/images/transactionItem.png")}
  />
);
...
export function HistoryItem({
  title,
  actionFn,
}: HistoryItemPropType): React.JSX.Element {
  return (
    <View
      style={[
        borderStyles.r15,
    ...
    >
      ...
      <View>
        <Text
          style={[smallStyles.small_bold, { color: efficiency.efficiencyMain }]}
        >
          {title}
        </Text>
      </View>
...
let whatsapp = (
  <Image
    style={styles.CSImage}
    source={require("../../assets/images/cs-whatsapp.png")}
  />
);
let inApp = (
  <Image
    style={styles.CSImage}
    source={require("../../assets/images/cs-inapp.png")}
  />
);
let call = (
  <Image
    style={styles.CSImage}
    source={require("../../assets/images/cs-call.png")}
  />
);
...
let notifImages = {
  bookingSuccess: (
    <Image
      style={[styles.NIImage]}
      source={require("../../assets/images/n-booking-success.png")}
    />
  ),
};
...
export function NotificationItem({
  type,
  text,
}: NotificationItemPropType): React.JSX.Element {
  ...
  return (
    <View style={[layoutVals.flexRow]}>
      ...
      >
        <Text style={[smallStyles.small_regular, nStyles[type], paddings.p10]}>
          {text}
        </Text>
      </View>
    </View>
...
export function UserMessageItem({
  children,
}: UserMessageItemPropType): React.JSX.Element {
  return (
...
export function AdminMessageItem({
  children,
}: UserMessageItemPropType): React.JSX.Element {
  return (
    <View style={[layoutVals.flexRow]}>
      <View
        style={[
          ...
          paddings.p15,
          boxWidth.wp70,
          { backgroundColor: efficiency.efficiencyMain },
        ]}
      >
...
export function RidersBookingItem({
  tag1,
  tag2,
}: RidersBookingItemProptype): React.JSX.Element {
  return (
    <View
      style={[
        borderStyles.bWidth2,
    ...
    >
      <FlexRow>
        ...
        <Flex1>
          <ParaBold>
            Delivery of Electronics to Mr Chuks at in Abule Egba Area.
          </ParaBold>
        </Flex1>
      </FlexRow>
      ...
      <ParaBold>
        <Text>
          Status:{" "}
          <Text style={{ color: utilityColors.errorDeep }}>
            Not Yet Delivered
          </Text>
        </Text>
      </ParaBold>
...
export function BookingGroup({
  ...
  detailsText,
  buttonText,
}: BookingGroupPropType): React.JSX.Element {
  return (
    <View>
      <FlexRow>
        <Flex0>
          <Image
            style={{ width: 50, height: 50 }}
            source={require("../../assets/images/icon11.png")}
          />
        </Flex0>
        <Flex0>
          <View style={[boxWidth.w10]} />
          ...
          >
            ...
            <View style={paddings.pt10}>
              <SCDesignSmall
                ...
                textStyle={{ color: gold.goldShade3 }}
              >
                {buttonText}
              </SCDesignSmall>
            </View>
...
export function AdminBookingItem({
  details,
  goToBookingDetails,
  assignRiders,
}: AdminBookingItemPropType): React.JSX.Element {
  return (
    <View
      style={[
        paddings.p15,
        borderStyles.r10,
        borderStyles.bWidth2,
        { borderColor: utilityColors.info2 },
      ]}
    >
      <View>
        <FlexRow alignCenter={true}>
          <Flex0>
            <Image
              style={{ width: 50, height: 50 }}
              source={require("../../assets/images/icon12.png")}
            />
          </Flex0>
      ...
      <View>
        <View style={[paddings.pt5]}>
          <Text>
            ...
            <Text style={paraStyles.para_regular}>Omoyele Ibrahim</Text>
          </Text>
        </View>
        <View style={[paddings.pt5]}>
          <Text>
            <Text style={paraStyles.para_bold}>Reciever: </Text>
            <Text style={paraStyles.para_regular}>Omoyele Ibrahim</Text>
          </Text>
        </View>
        <View style={[paddings.pt5]}>
          <Text>
            <Text style={paraStyles.para_bold}>Pickup Address: </Text>
            <Text style={paraStyles.para_regular}>
              Plot 1, Yaha Ahmed Street, Prince Mark Saffold Plaza, Ikeja, Lagos
            </Text>
          </Text>
        </View>
        <View style={[paddings.pt5]}>
          <Text>
            <Text style={paraStyles.para_bold}>Dropoff Address: </Text>
            <Text style={paraStyles.para_regular}>
              Plot 1, Yaha Ahmed Street, Dominos Pizza, Ikotun
            </Text>
          </Text>
        </View>
      </View>
        ...
        <FlexRow>
          <Flex1>
            <SCTransFill
              style={{
                borderColor: utilityColors.info2,
                backgroundColor: utilityColors.infoLight,
              }}
              textStyle={{ color: efficiency.efficiencyShade4 }}
              onPress={assignRiders}
            >
              Assign Rider
            </SCTransFill>
          </Flex1>
          ...
          <Flex1>
            <SCTransOutline
              style={{ borderColor: utilityColors.info2 }}
              textStyle={{ color: utilityColors.infoDeep }}
...
export function RidersItemComponent({
  name,
  employmentHistory,
  actionFn,
}: RidersItemComponentPropType): React.JSX.Element {
  return (
    <View>
      <FlexRow>
        <Flex0>
...
interface InvoicesDayItemPropType {
  date: string;
  amount: number;
  paid: number;
  unpaid: number;
...
export function InvoicesDayItem({
  date = "",
  amount = 0,
  paid = 0,
  unpaid = 0,
  actionFn,
}: InvoicesDayItemPropType): React.JSX.Element {
  return (
    <View>
      <FlexRow>
        <Flex0>
          <Image
            style={{ width: 50, height: 50 }}
            source={require("../../assets/images/icon13.png")}
          />
        </Flex0>
        <Flex0>
          <View style={[boxWidth.w10]} />
        ...
        <Flex1>
          ...
          >
            ...
            <View style={paddings.pt5} />
            <SmallBold>Summary</SmallBold>
            <ParaRegular>
              <Text>Total Invoices from Orders: {amount}</Text>
            </ParaRegular>
            <ParaRegular>
              <Text>Paid : {paid}</Text>
            </ParaRegular>
...
export function InvoiceItem({
  ...
  amount,
  paid,
}: InvoiceItemPropType): React.JSX.Element {
  let paidText = paid ? (
    <Text style={{ color: utilityColors.infoDeep }}>Paid</Text>
  ) : (
    <Text style={{ color: utilityColors.errorDeep }}>Not Paid</Text>
  ...
  return (
    ...
    >
      <MBDataItem1 field={"Booking ID"} value={bookingId} />
      <MBDataItem1 field={"Details"} value={details} />
      <MBDataItem1 field={"Date"} value={date} />
      <MBDataItem1 field={"Payment Method"} value={paymentMethod} />
      <MBDataItem1 field={"Amount"} value={amount} />
      <MBDataItem1 field={"Paid"} value={paidText} />
    </View>
  );
}

interface ChatMsgOverviewPropType {
  message: string;
  name: string;
  actionFn: () => void;
}

export function ChatMsgOverview({
  message = "",
  name = "",
  actionFn,
}: ChatMsgOverviewPropType): React.JSX.Element {
  return (
    <View
      style={[
        borderStyles.bWidth2,
      ...
      <TouchableOpacity onPress={actionFn}>
        <FlexRow>
          <Flex0>
            <Image
              style={{ width: 50, height: 50 }}
              source={require("../../assets/images/icon14.png")}
            />
          </Flex0>
          <Flex0>
            <View style={[boxWidth.w10]} />
