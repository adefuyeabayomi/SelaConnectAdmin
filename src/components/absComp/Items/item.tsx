...
export function InvoicesDayItem({date='',amount=0,paid=0,unpaid=0,actionFn}: InvoicesDayItemPropType): React.JSX.Element{
    return (
        <View>
            <FlexRow>
                <Flex0>
                ...
                <Flex1>
                    <View style={[borderStyles.bWidth2,borderStyles.r15,{borderColor: gold.goldTint2},paddings.p10]}>
                        ...
                        <ParaRegular><Text>Total Invoices from Orders: {amount}</Text></ParaRegular>
                        <ParaRegular><Text>Paid : {paid}</Text></ParaRegular>
                        <ParaRegular><Text>Unpaid : {unpaid}</Text></ParaRegular>
                        <View style={paddings.pt10}>
                            <SCDesignSmall onPress={actionFn} buttonStyle={{borderRadius: 8}} textStyle={{color: gold.goldShade3} }>View Invoices</SCDesignSmall>
                        </View>
                    </View>
                </Flex1>
            </FlexRow>
...
export function InvoiceItem({bookingId,details,date,paymentMethod,amount,paid}:InvoiceItemPropType): React.JSX.Element{
    let paidText = paid ? <Text style={{color: utilityColors.infoDeep}}>Paid</Text> : <Text style={{color: utilityColors.errorDeep}}>Not Paid</Text>
    return (
        <View style={[paddings.p15,borderStyles.bWidth2,borderStyles.r15,{borderColor: efficiency.efficiencyTint2}]}>
...
export function ChatMsgOverview({message='',name='',actionFn}: ChatMsgOverviewPropType): React.JSX.Element{
    return (
        <View style={[borderStyles.bWidth2,borderStyles.r15,{borderColor: utilityColors.info2},paddings.p10]}>
