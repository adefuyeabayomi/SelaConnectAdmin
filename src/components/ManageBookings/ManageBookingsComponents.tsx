...
import { centerText, h6Styles, paraStyles, smallStyles } from "../../styles/textstyles";
...
export function BookingSummary({children = <Text></Text>}): React.JSX.Element {
    return (
        <View style={[styles.BSContainer,borderStyles.r15,paddings.p15]}>
            <View>
                <Text style={[centerText.center,h6Styles.h6_bold,{color: efficiency.efficiencyShade4}]}>Booking Summary</Text>
            </View>
...
export function PaymentSummary({children = <Text></Text>}): React.JSX.Element {
    return (
        <View style={[styles.BSContainer,borderStyles.r15,paddings.p15]}>
            <View>
                <Text style={[centerText.center,h6Styles.h6_bold,{color: efficiency.efficiencyShade5}]}>Payment Summary</Text>
            </View>
            <View style={[paddings.pt10]}>
                <View style={[paddings.pt5]}>
...
export function PackageStatus({children = <Text></Text>}): React.JSX.Element {
    return (
        <View style={[styles.BSContainer,borderStyles.r15,paddings.p15]}>
            <View>
                <Text style={[centerText.center,h6Styles.h6_bold,{color: efficiency.efficiencyShade5}]}>Package Status</Text>
            </View>
            <View style={[paddings.pt10]}>
                <View style={[paddings.pt5]}>
...
export function UpdatesAndChanges({children = <Text></Text>}): React.JSX.Element {
    return (
        <View style={[styles.BSContainer,borderStyles.r15,paddings.p15]}>
            <View>
